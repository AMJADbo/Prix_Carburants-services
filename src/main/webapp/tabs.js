// Le fichier tabs.js gère la navigation entre les onglets (Liste/Carte) et met à jour la bannière de résultats
...
// --------------------------------------------------
// Mise à jour de la bannière de résultats
// --------------------------------------------------

// Fonction globale pour mettre à jour les textes et couleurs du bandeau selon l'onglet actif
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Sélectionne les vues (contenus) correspondantes
  ...
  function selectTab(tab) {
    if (tab === 'liste') {
      ...
      // Si la carte Leaflet existe, recalcule sa taille après un court délai
