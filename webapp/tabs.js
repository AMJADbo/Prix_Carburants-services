// Les icônes SVG stockées dans des variables pour éviter de les répéter
...
window.updateBanner = function () {
  ...
  if (!isCarte) {
    // ---> VUE LISTE : Utilise svgListe et couleur bleue
    ...
    // ---> VUE CARTE : Utilise svgCarte et couleur verte
